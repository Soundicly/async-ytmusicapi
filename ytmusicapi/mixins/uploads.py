...
class UploadsMixin:
    async def get_library_upload_songs(self, limit: int = 25, order: str = None) -> List[Dict]:
        """
    ...
    async def get_library_upload_albums(self, limit: int = 25, order: str = None) -> List[Dict]:
        """
    ...
    async def get_library_upload_artists(self, limit: int = 25, order: str = None) -> List[Dict]:
        """
